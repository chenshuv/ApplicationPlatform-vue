<template>
    <div id="index">
        ...
        <div class="table">
            <el-container style="height: 600px; border: 1px solid #eeeeee; border-radius: 10px;">
                <el-header style="text-align: right; font-size: 12px; height: 70px;border-radius: 8px;">
